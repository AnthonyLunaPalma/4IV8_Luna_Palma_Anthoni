...
const guitarrasRouter = require('./Routers/guitarras');
const comprasRouter = require('./Routers/compras');

app.use('/api/usuarios', usuariosRouter);
app.use('/api/guitarras', guitarrasRouter);
...
app.get('/api/*path', (req, res) => {
    res.json({
        ...
        endpoint : {
            ...
            guitarras : {
                listar : 'GET /api/guitarras',
                obtener : 'GET /api/guitarras/:id',
                crear : 'POST /api/guitarras',
                actualizar : 'PUT /api/guitarras/:id',
                eliminar : 'DELETE /api/guitarras/:id'
            },
            compras : {
